// =============================================================================
// Terminal Panel Renderer for Dockview
// =============================================================================
...
export class TerminalPanelRenderer implements IContentRenderer {
  private _element: HTMLElement;
  private resizeObserver: ResizeObserver | null = null;

  constructor() {
    this._element = document.createElement("div");
    this._element.className = "terminal-panel-content";

    const terminalContainer = document.createElement("div");
    terminalContainer.id = "terminal";
    this._element.appendChild(terminalContainer);
  }
  ...
  init(params: GroupPanelPartInitParameters): void {
    // Initialize terminal when panel is ready
    this.initTerminal();
  ...
  private async initTerminal(): Promise<void> {
    const container = this._element.querySelector("#terminal") as HTMLElement;
    if (!container) {
      console.error("[TerminalPanel] Container not found");
      return;
    }
